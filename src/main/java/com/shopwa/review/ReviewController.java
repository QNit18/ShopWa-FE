...
import com.shopwa.exception.ReviewNotFoundException;
import com.shopwa.product.ProductService;
...
public class ReviewController {
    ...
    public String listReviewByCustomerByPage(@PathVariable("pageNum") int pageNum,
                                             Model model, HttpServletRequest request,
                                             String keyword, String sortField, String sortDir) {
        Customer customer =  controllerHelper.getAuthenticatedCustomer(request);

        Page<Review> pageReviews = reviewService.listByCustomerByPage(customer, keyword, pageNum, sortField, sortDir);
        List<Review> listReviews = pageReviews.getContent();

        model.addAttribute("currentPage", pageNum);
        model.addAttribute("totalPages", pageReviews.getTotalPages());
        model.addAttribute("totalItems", pageReviews.getTotalElements());
		...
		if (endCount > pageReviews.getTotalElements()) {
			endCount = pageReviews.getTotalElements();
		}
    ...
    public String listByProductByPage(Model model, @PathVariable(name = "productAlias") String productAlias,
        ...
        Page<Review> pageReviews = reviewService.listByProduct(product, pageNum, sortField, sortDir);
        List<Review> listReviews = pageReviews.getContent();
    ...
    private String listByProductByFirstPage(@PathVariable(name = "productAlias") String productAlias,
                                            Model model, HttpServletRequest request){
