...
import com.shopwa.security.oauth.CustomerOAuth2User;
...
public class Utility {
    ...
    public static String formatCurrency(float amount, CurrencySettingBag settings) {
        ...
        String decimalPonitType = settings.getDecimalPointType();
        ...
        char decimalSeparator = decimalPonitType.equals("POINT") ? '.' : ',';
